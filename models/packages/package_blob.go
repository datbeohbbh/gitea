...
type PackageBlob struct {
	...
	HashMD5     string             `xorm:"hash_md5 varchar INDEX(md5) NOT NULL"`
	HashSHA1    string             `xorm:"hash_sha1 varchar INDEX(sha1) NOT NULL"`
	HashSHA256  string             `xorm:"hash_sha256 varchar INDEX(sha256) NOT NULL"`
	HashSHA512  string             `xorm:"hash_sha512 varchar INDEX(sha512) NOT NULL"`
